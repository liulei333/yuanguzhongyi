package com.yuangumedicine.common.map;
...
import com.yuangumedicine.common.location.activity.LocationAmapActivity;
import com.yuangumedicine.common.location.activity.LocationExtras;
import com.yuangumedicine.common.location.activity.NavigationAmapActivity;
...
public class NimDemoLocationProvider implements LocationProvider {
    ...
    public void openMap(Context context, double longitude, double latitude, String address) {
        Intent intent = new Intent(context, LocationAmapActivity.class);
