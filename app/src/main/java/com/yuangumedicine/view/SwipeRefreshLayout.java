...
//                    DebugLogUtil.getInstance().Info("Got ACTION_MOVE event but don't have an active pointer id.");
                    return false;
                }

                final int pointerIndex = MotionEventCompat.findPointerIndex(ev, mActivePointerId);
                if (pointerIndex < 0) {
//                    DebugLogUtil.getInstance().Info("Got ACTION_MOVE event but have an invalid active pointer id.");
                    return false;
                }
