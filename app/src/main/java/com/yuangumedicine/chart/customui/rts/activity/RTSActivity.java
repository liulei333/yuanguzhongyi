package com.yuangumedicine.chart.customui.rts.activity;
...
import com.yuangumedicine.chart.customui.rts.ActionTypeEnum;
import com.yuangumedicine.chart.customui.rts.doodle.DoodleView;
import com.yuangumedicine.chart.customui.rts.doodle.SupportActionType;
import com.yuangumedicine.chart.customui.rts.doodle.TransactionCenter;
import com.yuangumedicine.chart.customui.rts.doodle.action.MyPath;
...
public class RTSActivity extends UI implements View.OnClickListener {
    ...
    private void audioSwitch() {
        ...
        audioSwitchBtn.setBackgroundResource(audioOpen ? R.mipmap.icon_audio_open : R.mipmap.icon_audio_close);
    ...
    private void initAudioSwitch() {
        ...
        audioSwitchBtn.setBackgroundResource(R.mipmap.icon_audio_close);
    }
}
