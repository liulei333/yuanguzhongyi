package com.yuangumedicine.chart.customui;
...
import com.yuangumedicine.chart.customui.action.AVChatAction;
import com.yuangumedicine.chart.customui.action.FileAction;
import com.yuangumedicine.chart.customui.action.RTSAction;
import com.yuangumedicine.chart.customui.extension.CustomAttachParser;
import com.yuangumedicine.chart.customui.extension.CustomAttachment;
import com.yuangumedicine.chart.customui.extension.GuessAttachment;
import com.yuangumedicine.chart.customui.extension.RTSAttachment;
import com.yuangumedicine.chart.customui.extension.SnapChatAttachment;
import com.yuangumedicine.chart.customui.extension.StickerAttachment;
import com.yuangumedicine.chart.customui.viewholder.MsgViewHolderAVChat;
import com.yuangumedicine.chart.customui.viewholder.MsgViewHolderDefCustom;
import com.yuangumedicine.chart.customui.viewholder.MsgViewHolderFile;
import com.yuangumedicine.chart.customui.viewholder.MsgViewHolderGuess;
import com.yuangumedicine.chart.customui.viewholder.MsgViewHolderRTS;
import com.yuangumedicine.chart.customui.viewholder.MsgViewHolderSnapChat;
import com.yuangumedicine.chart.customui.viewholder.MsgViewHolderSticker;
import com.yuangumedicine.chart.customui.viewholder.MsgViewHolderTip;
 ...
 *
 * 自定义聊天界面
 * Created by starwrap on 2017-06-07.
 */
        ...
        NimUIKit.setMsgRevokeFilter(new MsgRevokeFilter() {
            ...
            public boolean shouldIgnore(IMMessage message) {
                if (message.getAttachment() != null
                    ...
                    // 视频通话消息和白板消息 不允许撤回
                    return true;
                } else if (message.getSessionId().equals(DemoCache.getAccount()+"")) {
                    // 发给我的电脑 不允许撤回
                    return true;
                }
                return false;
